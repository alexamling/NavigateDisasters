...
public class PedestrianObject : MonoBehaviour 
{
	...
	public float                                m_speed               = 0.0f;                 // the speed that the pedestrian object will travel at            
	...
	public float                                m_currentSpeed        = 10.0f;                 // this is always our current speed
	...
	void Update () 
	{
        m_Time = Time.time + Time.deltaTime;
		if(!m_currentNode)
		{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            m_currentSpeed = Mathf.Lerp(10, 0, 200);
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            m_currentSpeed = Mathf.Lerp(0, 10, 200);
